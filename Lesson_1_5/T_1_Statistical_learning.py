...
--------------- ВИПРОБУВАЛЬНИЙ ПОЛІГОН ДЛЯ ОПТИМІЗАЦІЇ ЕТАПІВ СТАТИСТИЧНОГО НАВЧАННЯ ---------------------------
...
5. Статистичне навчання парамерів поліноміальної моделі за рекурентним скалярним фільтром Калмана (альфа-бетта фільтр) - бібліотека numpy;
6. Статистичне навчання параметрів експоненційної моделі за традиційним рішенням - бібліотека scipy;
7. Статистичне навчання параметрів експоненційної моделі за R&D рішенням;
8. Прогнозування динаміки розвитку статистичного ряду за МНК.
9. Статистичне навчання параметрів поліноміальної моделі  - бібліотек statsmodels, scikit-learn;
