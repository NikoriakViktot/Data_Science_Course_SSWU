...
if __name__ == '__main__':
    ...
    Plot_AV(SV_AV, SV_AV, 'Коливання курсу USD в 2022/23 році за даними Ощадбанк')
    Stat_characteristics(SV_AV, 'Коливання курсу USD в 2022/23 році за даними Ощадбанк')
